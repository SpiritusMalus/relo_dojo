...
export const STRINGS = {
  en: {
    ...
    "login.gmailBlocked": "Sorry, Google email (Gmail) can't be used to sign in or sign up in Russia.",
  ...
  ru: {
    ...
    "login.gmailBlocked": "Извините, вход и регистрация через почту Google (Gmail) в России недоступны.",
