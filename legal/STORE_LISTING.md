...
- Each day you get a short set of exercises: multiple choice, build-the-sentence, match pairs,
  spot-the-error, and more — all by tapping, no typing required.
- Miss one? Get a clear explanation in your language, then try a fresh example of the same point.
- The app adapts: it focuses on your weak spots and the right difficulty for you.

**Stay motivated**
- Earn XP, keep a daily streak, and climb the belts from white to black.
...
## Category
- Primary: **Education**
- Secondary (Play): Education / Language learning

## Content rating / age
- Suggested: **Everyone / 4+**, but because accounts and free-text input exist, complete each store's
  rating questionnaire honestly. If user-entered text is a concern for your markets, choose the next
  tier (e.g. Teen / 12+). Decision: [OPERATOR TO CONFIRM].
...
- App icon (1024×1024), adaptive icon (Play).
- Screenshots per device size (Home, a tapped exercise, feedback/explanation, Progress/belts, shop).
- Feature graphic (Play, 1024×500).
- Short app preview video (optional).
